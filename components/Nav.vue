  ...
  <nav id="header">
    ...
    >
      <div class="pl-4 flex items-center">
        <a
          class="flex items-center justify-center text-white no-underline hover:no-underline font-bold text-2xl lg:text-4xl"
          href="#"
        >
          ...
          <img class="w-1/4 " src="~assets/images/broc-circle.png" />
          Broccoli Hub
        </a>
      </div>
...
<style scoped>
nav {
  @apply bg-green-700 fixed w-full z-30 top-0 text-black;
  /* @apply bg-green-400; */
}
</style>
